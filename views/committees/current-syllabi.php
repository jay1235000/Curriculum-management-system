...
<html lang="en">
	<head>
		<title>Committees | Up-to-Date Syllabi</title>
		<meta charset="utf-8">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Committees | Up-to-Date Syllabi</h1>
								</div>
								<ol class="breadcrumb">
									<li>
								...
								<div class="col-12">
									<div class="card">
										<div class="card-header bg-white">
											<h3 class="card-title">Up-to-Date <span class="text-bold">Syllabi</span></h3>
										</div>
