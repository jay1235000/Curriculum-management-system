...
<html lang="en">
	<head>
		<title>Committees | Edit Committees Details</title>
		<meta charset="utf-8">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Committees | Edit Committee Member's Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li class="active">
										<span>Edit Committee Member's Details</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Committees</h5>
												</div>
												<div class="panel-body">
													
													<h4>Committee Member's Profile</h4>
													<hr />
