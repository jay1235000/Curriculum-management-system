<?php 
	...
	$selQuery = "SELECT Syllabus_ID, Module_code, Module_name, Years_outdated, Approval_Status FROM syllabus WHERE Committee_ID = '$id'";
													...
													<tbody>
														<?php 
															...
															while($rows = mysqli_fetch_assoc($view)) {
																...
																<td align="."center".">
																	<a href='query-details.php?id=".$rows['Syllabus_ID']."' title='View Syllabus'><i class='fa fa-eye'></i></a>
																</td>
