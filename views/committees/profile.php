				...
				if (preg_match("/^[a-zA-Z-' ]*$/",$_POST['inputName'])) {
					if (filter_var($_POST['inputEmail'], FILTER_VALIDATE_EMAIL)) {
						if (preg_match("/^[a-zA-Z-' ]*$/",$_POST['inputNote'])) {
							...
							$updatequery = "UPDATE committee_members SET Name = '$name', Email = '$email', Address = '$address', Note = '$note', Skill = '$skills', Position = '$position', Education = '$education'  WHERE Member_ID = '$id'";
                ...
                <div class="main-content">
                    <div class="wrap-content container" id="container">
                        ...
                        <section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Committee | Profile</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Committee</span>
						...
						<div class="container-fluid container-fullw">
                            <div class="row">
                                <div class="col-md-3">
									<?php 
										$id = $_SESSION['mid'];
										$sql1 = mysqli_query($conn,"SELECT * FROM committee_members WHERE Member_ID = '$id'");
