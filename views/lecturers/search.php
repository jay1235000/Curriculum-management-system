				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Lecturers | Manage Syllabus</h1>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Lecturers</span>
								...
								<div class="col-md-12">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="edit-syllabus.php?id=<?php echo $row['Module_code']; ?>"><i class="fa fa-edit"></i></a> || 
												<a href="view-syllabus.php?id=<?php echo $row['Module_code']; ?>"><i class="fa fa-eye"></i></a>
											</td>
										</tr>
										<?php 
											$cnt=$cnt+1;
